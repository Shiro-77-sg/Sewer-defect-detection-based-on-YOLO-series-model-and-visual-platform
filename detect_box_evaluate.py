...
def get_severity_and_solution(defect_type, area):
    ...
    if defect_type == "Disconnect":
        if area < 200:
            return "Low", "Disconnect: Routine inspection and minor patching"
        elif 200 <= area < 800:
            return "Medium", "Disconnect: Moderate patching and protection measures"
        else:
            return "High", "Disconnect: Immediate repair and extensive protective measures"
...
# Example usage
process_video('video.mp4', 'video_output.avi')
